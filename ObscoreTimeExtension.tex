...
{\color{blue}t\_origin} & Time frame origin & TimeOffset.time0 & timeorigin & time.epoch &  &	opt	\\  \hline
{\color{blue}t\_scale} &	Time frame scale & TimeFrame.timeScale &timescale& time.scale &	?&opt 	\\ \hline 
{\color{blue}t\_refPosition} &  Time reference position & TimeFrame.refPosition& refposition & & &opt	\\  \hline 
{\color{blue}t\_refDirection} &Time reference direction&TimeFrame.refDirection&refdirection &	& & opt 	\\ \hline 
%Time representation  ISOtime, MJD, JD, ?						
{\color{blue}t\_format}&	Time representation	& &  & time;meta.code.class&	null	&opt	\\ \hline 
...
% \end{sidewaystable} 
 ...
 SELECT date_obs, obs_publisher_did, obs_collection, access.reference FROM ivoa.obscore 
 WHERE dataproduct_type=='ligh-curve'
 AND date_obs BETWEEN 36050  AND 36100
