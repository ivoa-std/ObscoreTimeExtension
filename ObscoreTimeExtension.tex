...
IVOA architecture \citep{p{2021ivoa.spec.1101D}. This specification builds up a metadata profile that must be used in a TAP service based on the ObsTAP TAP schema.
...
\todo{table names to be discussed }.
